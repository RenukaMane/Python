...
void PrintCUDADeviceProperties(void)
{
    ...
    {
        printf("Ther is No CUDA Supported Device On This System.\n");
        return;
    }
    else
    {
        ...
        for(int i = 0; i < dev_count; i++)
        {
            ...
            printf("GPU Device Total Memory                                        : %.0fGB = %.0f MB = %llu Bytes\n",((float)dev_prop.totalGlobalMem / 1048576.0f / 1024.0f), ((float)dev_prop.totalGlobalMem / 104857.0f), (unsigned long long )dev_prop.totalGlobalMem);
            ...
            printf("================================================================\n");
            printf("GPU Device hass ECC support                                     : %s\n", dev_prop.ECCEnabled ? "Enabled" : "Disabled");
